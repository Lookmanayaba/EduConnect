                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                    ...
                    <div className="p-3.5 bg-zinc-50 dark:bg-zinc-950 rounded-xl space-y-1 relative">
                      ...
                      <div className="flex items-center justify-between gap-2">
                        <span className="text-zinc-850 dark:text-zinc-200 font-mono font-semibold">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-1.5 mt-1">
                            {matchingTeacher?.subjects.map(subj => (
                              <span key={subj} className="px-2.5 py-1 bg-teal-50 dark:bg-teal-950 text-teal-800 dark:text-teal-300 font-bold rounded-lg border border-teal-100 dark:border-teal-900/30">
                                {subj}
                              </span>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-white dark:bg-zinc-900 border border-zinc-150 dark:border-zinc-800 p-5 rounded-2xl shadow-3xs text-xs space-y-3">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-1 bg-zinc-50 dark:bg-zinc-950 p-3 rounded-xl font-semibold">
                  ...
                  <div className="flex items-center justify-between p-3 bg-zinc-50 dark:bg-zinc-950 rounded-xl">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none cursor-pointer ${
                        isDarkMode ? 'bg-[#00A896]' : 'bg-zinc-300'
                      }`}
